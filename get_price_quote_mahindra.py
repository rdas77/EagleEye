...
cur.callproc('NSE_MOVEMENT_TRANS_PRC', (json.dumps(q),'M&M',VAR_LAST_ONE_QTY,VAR_CURR_TRD_QTY,VAR_ONE_DAY_RATIO,VAR_LAST_FIVE_QTY,VAR_FIVE_DAY_RATIO,VAR_CURRENT_PRC))
cur.close()
