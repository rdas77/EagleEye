...
print("The prvious close price:-"v_previousClose)
con = cx_Oracle.connect('EQUITY/EQUITY@127.0.0.1/XE')
cur = con.cursor()
cur.callproc('DILLIP_FORMULA_PRC', ('M&MFIN',v_open,v_high,v_low,v_quantitytraded,v_lastprice,v_averageprice,v_previousClose))
cur.close()
